      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">
        <div className="w-[90%] max-w-md bg-slate-900/80 border border-slate-700 rounded-2xl shadow-2xl p-8 text-slate-100">
          ...
          <p className="text-xs text-slate-400 text-center mb-6">
            Register as <span className="font-semibold text-blue-400">Admin</span>, Teacher, Student or Parent
          </p>
          ...
          <form className="space-y-4" onSubmit={submitForm}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-2.5 rounded-lg bg-blue-500 hover:bg-blue-600 text-sm font-semibold transition flex items-center justify-center"
            >
